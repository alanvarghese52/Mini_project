  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="edit.php"><span class="img" style="background-image: url(images/author.jpg);"></span><?php echo $_SESSION['username']; ?></a></h1>
					...
					<div class="d-flex align-items-center js-fullheight">
						...
						<div class="author-info text p-3 p-md-5">
							<div class="desc">
								...
								<h1 class="mb-4"><span><?php echo $_SESSION['username']; ?></span> , A Photographer.</h1>
								...
								<h3 class="signature h1"><?php echo $_SESSION['username']; ?></h3>
